    ...
    <div class="customizer-body" data-perfect-scrollbar data-suppress-scroll-x="true">
        <div class="card">
            ...
            <div id="collapseOne" class="collapse show" aria-labelledby="headingThree"
                ...
                <div class="card-body">
                    <div class="">
                        <a title="Compact Sidebar" href="{{route('normal')}}" class="btn btn-primary"> Normal Sidebar
                        </a>
                        <a title="Horizontal Layout" href="{{route('horizontal')}}" class="btn btn-primary"> Horizontal
                            Layout</a>
